  ...
  return (
    <div className="flex justify-center mt-4 ">
      <div>
          ...
          {result && <Button onClick={handleResult} style={"bg-orange-300 px-10 py-2 rounded hover:bg-orange-400 mt-3"} >Show Results</Button>}; /* eslint-disable-line*/
          {start && <Button onClick={ handleStart} style={"bg-orange-300 px-10 py-2 rounded hover:bg-orange-400"}>Start Quiz</Button>   };/*eslint-disable-line*/
      </div>
    </div>
  );
}
